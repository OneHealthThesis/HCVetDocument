...
\title{Saludata: Aplicación para la gestión de información de animales domésticos}
\author{\\\vspace{0.25cm}Adrian Hern\'andez P\'erez\\Victor Manuel Lantigua Cano}
...
\date{Fecha\\\vspace{0.25cm}\href{https://github.com/OneHealthThesis/HCVetDocument}{github.com/OneHealthThesis/HCVetDocument}}
